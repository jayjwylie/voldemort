...
public class SocketStore implements Store<ByteArray, byte[], byte[]>, NonblockingStore {
     ...
     * response from the server.
     * 
     * @param <T> Type of client request
     * @param delegate The ClientRequest implementation used to write the
     *        request and read the response
     * @param callback The callback to invoke upon completion (successful or
     *        otherwise)
     * @param timeoutMs The timeout for this operation in ms.
     * @param operationName Simple string representing the type of request
     */
